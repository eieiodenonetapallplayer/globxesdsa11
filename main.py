...
def generate_stt_sql(json_data):
    ...
    values = {
        ...
        'taxid': clean_sql_string(tax_id, 30),
                'nationality': clean_sql_string(data.get('nationality', ''), 5),
        'mail_same_flag': clean_sql_string(data.get('mailingAddressSameAsFlag', {}).get('key', '') if isinstance(data.get('mailingAddressSameAsFlag'), dict) else '', 20),
        ...
        'cont_same_flag': clean_sql_string(data.get('contactAddressSameAsFlag', {}).get('key', '') if isinstance(data.get('contactAddressSameAsFlag'), dict) else '', 20),
        ...
        'redemp_bank_account_name': clean_sql_string(redemption_accounts.get('bankAccountName', ''), 200),
